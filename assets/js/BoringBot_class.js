...
BoringBot.prototype.name = "Barack O-bot-ma";

BoringBot.prototype.placeShips = function(ships) {
	var placements = [];
...
BoringBot.prototype.takeTurn = function(turns) {
	var new_x = 0;
	var new_y = 0;
...
BoringBot.prototype.rand = function(boundry) {
	return Math.floor(Math.random() * boundry);
};

BoringBot.prototype.shipFits = function(x, y, axis, size) {
	var fits = false;
...
BoringBot.prototype.shipOverlaps = function(x, y, axis, size, placements) {
	var overlaps = false;
